...
The underlying business context is insurance, but the analytical workflow is applicable to other regulated and data-intensive industries such as **financial services, pharmaceuticals, energy, and technology**.

---

## 🌎 International Edition

This English edition presents the same analytical work developed for the Chilean insurance market, adapted for an international audience.

The original data, regulatory context, methodology, and analytical results remain unchanged. The communication layer — including documentation, dashboard terminology, and business explanations — is adapted into professional English.

> **One analytical project. Two professional presentations.**
>
> 🇨🇱 Spanish edition — Chilean market and local applications  
> 🌎 English edition — multinational and international applications
